...
#	subprocess.call (["cd", /home/pi"])
	...
	subprocess.call (["sudo", "apt-get", "-y", "install", "python3-pandas"])
	...
	subprocess.call (["sudo", "pip3", "install", "plotly"])
	subprocess.call (["sudo", "pip3", "install", "seaborn"])
	subprocess.call (["sudo", "pip3", "install", "numpy==1.18"])
